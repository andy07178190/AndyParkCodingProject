...
# mount Box to WSL
sudo mount -t drvfs "C:\Users\rm57578\Box" /mnt/box

# define paths
path_project_data="/mnt/c/Users/rm57578/Documents/GitHub/cel_repeat_expression/data/counts"
path_repeat_counts_data="/mnt/box/Sarinay_Cenik_lab_resources/lab_members/past_members/Trevor Freeman/repeats_expression/data/counts"
