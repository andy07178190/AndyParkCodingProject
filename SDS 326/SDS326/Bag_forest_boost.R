...
library(tree)
install.packages("randomForest")#This library is used for classification and regression trees
library(randomForest)
install.packages("gbm") #This library is used for bagging and random forests
...
setwd("/Users/baghuijae/Desktop/class coding/SDS 326/SDS326")
